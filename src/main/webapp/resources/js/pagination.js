(function(global, factory) {
	...
	var Pagination = /** @class */ (function() {
		...
		Pagination.prototype.recreatePageElements = function(pageNumber) {
			...
			var previousPageLi = this.createPageElement("<i class='fa-solid fa-angles-left'></i>", previousPage);
			var nextPageLi = this.createPageElement("<i class='fa-solid fa-angles-right'></i>", nextPage);
